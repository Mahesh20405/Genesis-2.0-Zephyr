...
# Loop through the combinations of layers and nodes
for dense_layer in dense_layers:
    for layer_size in layer_sizes:
        for conv_layer in conv_layers:
            # Replace invalid characters in the NAME string
            NAME = "Final_{}-conv-{}-nodes-{}-dense-0.2-Dropout-{}".format(
                conv_layer, layer_size, dense_layer, int(time.time()))
            
            # Initialize TensorBoard in the loop
            tensorboard = TensorBoard(log_dir='logs/{}'.format(NAME))
            print(NAME)  # Output: Final_2-conv-128-nodes-2-dense-0.2-Dropout-...
            ...
            # Save the model
            model.save('F:/NEWWW/p1/model.h5')
