...
# Ensure data is reshaped correctly
...
# The final model: 2-conv-64-nodes-2-dense-0.2-Dropout
dense_layers = [2]
layer_sizes = [64]
conv_layers = [2]
...
for dense_layer in dense_layers:
    for layer_size in layer_sizes:
        for conv_layer in conv_layers:
            ...
            NAME = "Final_{}-conv_{}-nodes_{}-dense_0.2-Dropout_{}".format(
                conv_layer, layer_size, dense_layer, timestamp)
            ...
            print(NAME)  # Example output: Final_2-conv_64-nodes_2-dense_0.2-Dropout_1725811871
